...
val USEFUL_STATUS_EFFECTS = listOf(
    StatusEffect("speed", isNegative=false, isInstant=false),
    StatusEffect("slowness", isNegative=true, isInstant=false),
    StatusEffect("haste", isNegative=false, isInstant=false),
    StatusEffect("strength", isNegative=false, isInstant=false),
    StatusEffect("instant_health", isNegative=false, isInstant=true),
    StatusEffect("instant_damage", isNegative=true, isInstant=true),
    StatusEffect("jump_boost", isNegative=false, isInstant=false),
    StatusEffect("regeneration", isNegative=false, isInstant=false),
    StatusEffect("resistance", isNegative=false, isInstant=false),
    StatusEffect("fire_resistance", isNegative=false, isInstant=false),
    StatusEffect("water_breathing", isNegative=false, isInstant=false),
    StatusEffect("invisibility", isNegative=false, isInstant=false),
    StatusEffect("blindness", isNegative=true, isInstant=false),
    StatusEffect("night_vision", isNegative=false, isInstant=false),
    StatusEffect("hunger", isNegative=true, isInstant=false),
    StatusEffect("weakness", isNegative=true, isInstant=false),
    StatusEffect("poison", isNegative=true, isInstant=false),
    StatusEffect("wither",  isNegative=true, isInstant=false),
    StatusEffect("absorption", isNegative=false, isInstant=false),
    StatusEffect("saturation", isNegative=false, isInstant=false),
    StatusEffect("fatal_poison", isNegative=true, isInstant=false),
)
